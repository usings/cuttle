...
function DialogOverlay({ className, ...props }: DialogPrimitive.Backdrop.Props) {
  return (
    <DialogPrimitive.Backdrop
      ...
      className={cn(
        // Base UI's own transition route, the one `SheetOverlay`, `DrawerOverlay` and the popover's
        // backdrop already take: start and end at zero opacity and let the transition carry it. The
        // keyframe route reached the same picture, but a backdrop is a single fade and there is no
        // reason for two mechanisms to exist side by side for it.
