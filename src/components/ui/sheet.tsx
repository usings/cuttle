  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          // The Drawer's motion, so the two halves of `SideSurface` behave alike: the panel slides
          // its full width off the edge on the Drawer's 450ms curve, rather than nudging 2.5rem and
          // fading. `--sheet-offset` lets an inset panel travel past its own gap.
