...
function AlertDialogOverlay({ className, ...props }: AlertDialogPrimitive.Backdrop.Props) {
  return (
    <AlertDialogPrimitive.Backdrop
      ...
      className={cn(
        // Base UI's own transition route, matching `DialogOverlay` and the sheet, drawer and popover
        // backdrops. See `DialogOverlay` for why a backdrop does not need the keyframe route.
